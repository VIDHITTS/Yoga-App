...
const generateSafetyMessage = (categories) => {
  const categoryMessages = {
    ...
    cardiovascular:
      "Heart conditions require careful monitoring during physical activity.",
    musculoskeletal:
      "Spinal and structural injuries need professional assessment before yoga practice.",
    chronicDiseases: "Chronic conditions require personalized modifications.",
    neurologicalConditions:
      "Neurological conditions require specialized guidance.",
    cancer: "Cancer treatment requires gentle, therapeutic approaches.",
    respiratoryIssues:
      "Respiratory conditions need breath-aware modifications.",
    recentTrauma:
      "Recent injuries require healing time before resuming practice.",
  };

  const messages = categories
